...
transform = transforms.Compose([transforms.Resize((224, 224)),
                                transforms.ToTensor()])
train_dataset = torchvision.datasets.ImageFolder(root='archive/landscapeImages/color', transform=transform)
val_dataset = torchvision.datasets.ImageFolder(root='archive/landscapeImages/gray', transform=transform)
